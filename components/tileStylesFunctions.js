...
export function makeStyleResponsiveDynamic(number,gameGridCellNTileSquareSize ){
console.log('makeStyleResponsiveDynamic', )
    ...
    switch (number) {
      ...
      let result;
      result=[styleResponsiveDynamic.responsiveInnerTile,{
      textAlign: 'center',
      fontWeight: 'bold',
      borderRadius: 5,
    }]
